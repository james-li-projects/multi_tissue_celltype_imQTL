...
# Single-cell eQTL cell-type lookup map
sceqtl_celltype_map <- c(
  "B_IN" = "Immature/naive B cell",
  "B_Mem" = "Memory B cell",
  "CD4_ET" = "CD4+ effector T cell",
  "CD4_NC" = "CD4+ naive/central memory T cell",
  "CD4_SOX4" = "SOX4-expressing CD4+ T cell",
  "CD8_ET" = "CD8+ effector T cell",
  "CD8_NC" = "CD8+ naive/central memory T cell",
  "CD8_S100B" = "S100B-expressing CD8+ T cell",
  "DC1" = "Type 1 conventional dendritic cell",
  "Mono_C" = "Classical monocyte",
  "Mono_NC" = "Non-classical monocyte",
  "NK" = "Natural killer cell",
  "NK_R" = "Recruiting natural killer cell",
  "Plasma" = "Plasma cell",
  "Neutro" = "Neutrophil"
)
...
OUTPUT_TABLE_SCEQTL_COLOC <- coloc_data %>%
  filter(coloc_0.5_all == TRUE) %>%
  mutate(
    tissue = tissue_map[tissue],
    celltype = celltype_map[celltype],
    sceqtl_ct = unname(sceqtl_celltype_map[sceqtl_ct]),
...
ggsave(
  filename = "/gpfs/data/pierce-lab/james.li/imQTL/output/SCEQTL_coloc/default_prior/pie_chart_heals_imqtls_coloc_with_sceqtls_by_celltype.png",
  plot = final_plot,
  width = 10,
  height = 9,
  dpi = 300,
