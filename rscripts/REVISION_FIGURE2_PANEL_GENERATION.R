...
setwd("/gpfs/data/pierce-lab/james.li/imQTL/output/regional_plots_revision")
...
##############################
# User-supplied values -- interaction coloc #5
query_phenotype <- "cg21130420"
query_variant <- "chr2:113827728:A:G"
query_rsid <- "rs11676646"
dataset="GTEx"
current_tissue="colon"
tmp_combination="colon_Stromal"
...
ggsave(
  filename = paste0("/gpfs/data/pierce-lab/james.li/imQTL/output/regional_plots_revision/figure2/boxplot_",
...
# Save the plot
ggsave(
  filename = paste0("/gpfs/data/pierce-lab/james.li/imQTL/output/regional_plots_revision/figure2/regional_plot_", tmp_combination, "_",
