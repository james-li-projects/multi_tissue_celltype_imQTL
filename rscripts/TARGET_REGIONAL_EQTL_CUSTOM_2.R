...
query_ensg="ENSG00000124198.8"
query_rsid="rs35393280"
query_gwas_file="/gpfs/data/pierce-lab/james.li/GWAS_Trait_87/imputed_GIANT_HEIGHT.txt.gz"
...
# RBIND ALL PLOT DFS #   
######################
plot_df <- rbind(data_imqtl,data_gwas,data_eqtl) %>% filter(POS<49175000)
