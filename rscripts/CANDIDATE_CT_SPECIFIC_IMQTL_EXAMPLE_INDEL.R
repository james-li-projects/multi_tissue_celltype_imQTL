...
candidate_str="colon_Epi.cg14111612.chr15:32899146:AAAAC:A"
...
imqtl_requests <- fread("/gpfs/data/pierce-lab/james.li/imQTL/output/CANDIDATE_CT_SPECIFIC/tables/candidate_ct_specific_imqtl_DF.tsv") %>% rename(current_tissue=tissue) %>% select(-celltype) %>% filter(lead_variant_raw==query_variant) 
