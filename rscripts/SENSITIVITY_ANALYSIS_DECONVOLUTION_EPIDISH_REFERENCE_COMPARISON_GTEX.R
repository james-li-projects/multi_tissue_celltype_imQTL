...
load("/gpfs/data/pierce-lab/james.li/imQTL/output/GTEx/cell_type_frac/estF.wb.RData")

# converting to dataframes
estF.o_cent12CT <- data.frame(estF.o_cent12CT)
estF.o <- data.frame(estF.o)

# making rownames neater
rownames(estF.o) <- gsub("-",".",rownames(estF.o))
rownames(estF.o_cent12CT) <- gsub("-",".",rownames(estF.o_cent12CT))
...
# ---- save ----
ggsave(
  filename = "/gpfs/data/pierce-lab/james.li/imQTL/output/GTEx/cell_type_frac/Reinius_vs_cent12CT.png",
  plot = p,
  width = 28,
  height = 4.5,
  units = "in",
