#!/bin/bash
#SBATCH --job-name=tensorQTL_imQTL_ALL
#SBATCH --output=/gpfs/data/pierce-lab/james.li/imQTL/logs/tensorQTL_imQTL_ALL_%A.out
#SBATCH --error=/gpfs/data/pierce-lab/james.li/imQTL/logs/tensorQTL_imQTL_ALL_%A.err
...
prefix="/gpfs/data/pierce-lab/james.li/imQTL/output/${dataset}/imQTL/full_assoc/tensorQTL_imQTL_${tissue}_${cell_type}"
