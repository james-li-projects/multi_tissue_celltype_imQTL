...
#SBATCH --output=/gpfs/data/pierce-lab/james.li/imQTL/logs/tensorQTL_mQTL_BEST_ONLY_%A.out
#SBATCH --error=/gpfs/data/pierce-lab/james.li/imQTL/logs/tensorQTL_mQTL_BEST_ONLY_%A.err
...
prefix="/gpfs/data/pierce-lab/james.li/imQTL/output/${dataset}/mQTL/top_assoc/tensorQTL_mQTL_${tissue}"
